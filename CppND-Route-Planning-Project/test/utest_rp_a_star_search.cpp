...
TEST_F(RoutePlannerTest, TestCalculateHValue) {
    std::cout << "Start Node H-Value: " << route_planner.CalculateHValue(start_node) << std::endl;
    EXPECT_FLOAT_EQ(route_planner.CalculateHValue(start_node), 1.1329799);
    
    std::cout << "End Node H-Value: " << route_planner.CalculateHValue(end_node) << std::endl;
    EXPECT_FLOAT_EQ(route_planner.CalculateHValue(end_node), 0.0f);
    
    std::cout << "Mid Node H-Value: " << route_planner.CalculateHValue(mid_node) << std::endl;
